...
```{r Set up hidden, message=FALSE, echo=FALSE}
# Directory
#setwd(file.path = "")

# Load packages
packages <- c("tidyverse", "xtable")
...
In order to make our project manageable and easy to navigate we will create a new folder for the data, then save various versions of the dataframe `df` in it for later
